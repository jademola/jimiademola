    ...
    <div id='education' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <div className='flex flex-col lg:flex-row gap-6 my-20 justify-center'>
        ...
        <div className='lg:w-1/2 border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer 
          ...
          <h3 className='text-xl font-semibold mb-2'>Bachelor of Science, Computer Science</h3>
          <p className='mb-4 font-Outfit text-gray-600'>Honed the fundamentals including data structures, algorithms and machine learning.</p>
        ...
        <div className='lg:w-1/2 flex flex-col gap-3'>
          {/* Certificate boxes remain unchanged */}
      ...
      {/* Instagram embed below education section */}
      <div className="mt-10 flex justify-center">
        <div dangerouslySetInnerHTML={{ __html: instagramEmbed }} />
      </div>
    </div>
  )
}
